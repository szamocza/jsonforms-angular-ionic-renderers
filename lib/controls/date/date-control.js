...
import { getLocale, isDateControl, rankWith } from 'jsonforms/packages/core';
...
var getLocaleDateString = function (locale) {
...
var DateControlRenderer = /** @class */ (function (_super) {
    ...
    DateControlRenderer.prototype.openPicker = function () {
        var _this = this;
        var select = this.modalCtrl.create(DateModalComponent, {
            title: this.label,
            date: this.data,
            canClear: true,
    ...
    DateControlRenderer = __decorate([
        Component({
            ...
            template: "\n      <ion-item no-padding no-lines (click)=\"openPicker()\" [ngStyle]=\"uischema && uischema.options && uischema.options.style\">\n        <ion-label stacked>{{ label }}</ion-label>\n        <ion-label l10nTranslate>{{data ? (data | date:dateFormat) : ('V\u00E1lasszon' | translate:locale)}}</ion-label>\n      </ion-item>\n  "
        }),
...
export var dateControlTester = rankWith(2, isDateControl);

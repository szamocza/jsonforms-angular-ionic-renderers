...
var DateTimeControlRenderer = /** @class */ (function (_super) {
    ...
    DateTimeControlRenderer.prototype.openTimePicker = function (noDatePickerOpener) {
        var _this = this;
    ...
    DateTimeControlRenderer.prototype.openDatePicker = function (noTimePickerOpener) {
        var _this = this;
        var date = undefined;
        var oldHour = 0;
        var oldMinute = 0;
            ...
            if (role == 'done') {
                if (date) {
                    ...
                    if (!noTimePickerOpener) {
                        setTimeout(function () { return _this.openTimePicker(true); }, 150);
                    }
                }
                else {
                    _this.handleChange(undefined);
    ...
    DateTimeControlRenderer.prototype.focusDatePicker = function () {
        var _this = this;

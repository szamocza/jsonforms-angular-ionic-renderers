...
var AttachmentControlRenderer = /** @class */ (function (_super) {
    ...
    function AttachmentControlRenderer(ngRedux) {
    ...
    AttachmentControlRenderer.prototype.attach = function () {
        ...
        if (this.uischema && this.uischema.context && this.uischema.context.selectAttachment) {
            this.uischema.context.selectAttachment().then(function (data) {
...
exports.attachmentControlTester = core_2.rankWith(3, core_2.and(core_2.isStringControl, core_2.optionIs('attachment', true), core_2.formatIs('uri')));

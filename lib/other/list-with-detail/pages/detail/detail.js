...
var AbstractDetailPage_1 = require("../AbstractDetailPage");
var DetailPage = /** @class */ (function (_super) {
    ...
    function DetailPage(navParams) {
        ...
        _this.isSplit =
            _this.item && _this.item.isSplit !== undefined ? _this.item.isSplit : true;
        return _this;
    }
    ...
    return DetailPage;
}(AbstractDetailPage_1.AbstractDetailPage));

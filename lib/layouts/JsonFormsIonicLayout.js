...
var JsonFormsIonicLayout = /** @class */ (function (_super) {
    ...
    JsonFormsIonicLayout.prototype.ngOnInit = function () {
        ...
        this.subscription = this.ngRedux
            ...
            _this.uischema = __assign({}, props.uischema);
            ...
            if (scope) {
                ...
                if (scopeInfo != null) {
                    _this.setScopeClazz(scopeInfo);
                    if (_this.selector && scopeInfo.length > 0) {
                        var selectorVal = _this.selector(scopeInfo[0]);
                        if (selectorVal != null) {
                            _this.visible = selectorVal != core_2.FieldPhaseSelector.HIDDEN;
                            _this.hidden = selectorVal == core_2.FieldPhaseSelector.HIDDEN;
                            _this.disabled = _this.disabled || selectorVal == core_2.FieldPhaseSelector.READONLY;
                            _this.readonly = _this.readonly || selectorVal == core_2.FieldPhaseSelector.READONLY;
            ...
            if (_this.uischema && _this.uischema.elements) {
                _this.uischema.elements.map(function (element) {
                    if (element) {
                        element.readonly = _this.readonly;
                        if (_this.uischema.options) {
                            if (!element.options)
                                element.options = {};
                            for (var key in _this.uischema.options) {
                                if (_this.uischema.options.hasOwnProperty(key) && key != "pictureUri") {
    ...
    JsonFormsIonicLayout.prototype.setScopeClazz = function (scopeInfo) {

...
var JsonFormsIonicLayout = /** @class */ (function (_super) {
    ...
    JsonFormsIonicLayout.prototype.ngOnInit = function () {
        ...
        this.subscription = this.ngRedux
            ...
            if (_this.uischema && _this.uischema.options && _this.uischema.options.style && _this.uischema && _this.uischema.elements) {
                _this.uischema.elements.map(function (element) {
                    if (element) {
                        if (!element.options)
                            element.options = {};
                        if (!element.options.style)
                            element.options.style = _this.uischema.options.style;
                    }
                    return element;
                });
            }

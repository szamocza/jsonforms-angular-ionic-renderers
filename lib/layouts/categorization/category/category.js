...
var CategoryRenderer = /** @class */ (function (_super) {
    ...
    function CategoryRenderer(navParams, paramsService) {
        ...
        _this.label = label;
        _this.elements = uischema.elements.map(function (el) { return ({
            uischema: el,
            schema: schema,
            path: path
        }); });

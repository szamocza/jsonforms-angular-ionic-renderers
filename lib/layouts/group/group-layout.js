...
var GroupLayoutRenderer = /** @class */ (function (_super) {
    ...
    function GroupLayoutRenderer(ngRedux) {
        ...
        _this.height = 42;
        _this.width = 42;
        _this.labelClicked = false;
        // @ts-ignore
        _this.mapAdditionalProps = function (props) {
            if (_this.uischema.options) {
                if (_this.uischema.options.width) {
                    _this.width = _this.uischema.options.width;
                }
                if (_this.uischema.options.height) {
                    _this.height = _this.uischema.options.height;
                }
            }
        };
